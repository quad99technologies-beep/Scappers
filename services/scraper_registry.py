...
SCRAPER_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "Italy": {
        ...
        "path": "scripts/Italy",
        "steps": [
            {"name": "00 - Init / Schema", "script": "steps/step_00_backup_clean.py", "desc": "Apply Italy PostgreSQL schema (idempotent)"},
            {"name": "01 - List Determinas", "script": "steps/step_01_list_determinas.py", "desc": "Month-by-month AIFA search for DET + Riduzione (resumable)"},
            {"name": "02 - Download Sources", "script": "steps/step_02_download_pdfs.py", "desc": "Download PDF attachments and persist detail JSON in DB"},
            {"name": "03 - Extract Data", "script": "steps/step_03_extract_data.py", "desc": "Extract AIC + prices from PDFs and MSF details"},
            {"name": "04 - Export Excel", "script": "steps/step_04_export.py", "desc": "Export DET and Riduzione Excel reports"},
        ],
        "pipeline_bat": "run_pipeline.bat",
        "pipeline_script": "run_pipeline_resume.py",
