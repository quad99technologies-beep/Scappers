...
def generate_report(final_df, bulk_df, missing_regnos):
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        if missing_regnos_list:
            ...
            f.write("=" * 80 + "\n")
            f.write("✅ All expected registration numbers were found!\n")
            f.write("\n")
        ...
        if missing_product_name_list:
            ...
            f.write("=" * 80 + "\n")
            f.write("✅ All products have Product Name!\n")
            f.write("\n")
        ...
        if missing_holder_list:
            ...
            f.write("=" * 80 + "\n")
            f.write("✅ All products have Holder information!\n")
            f.write("\n")
        ...
        f.write("=" * 80 + "\n")
        if total_missing > 0:
            f.write(f"⚠️  {total_missing} registration numbers were not found. These may be:\n")
        ...
        if len(missing_product_name_list) > 0 or len(missing_holder_list) > 0:
            f.write("⚠️  Some products are missing Product Name or Holder information.\n")
            f.write("   Consider re-running Script 02 to retry extraction.\n")
            f.write("\n")
        if coverage_pct >= 95:
            f.write("✅ Excellent coverage! (>95%)\n")
        elif coverage_pct >= 80:
            f.write("⚠️  Good coverage, but some products are missing.\n")
        else:
            f.write("❌ Low coverage. Review missing products and retry.\n")
        f.write("\n")
