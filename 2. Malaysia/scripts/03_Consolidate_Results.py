...
# Paths
output_base_dir_path = getenv("SCRIPT_03_OUTPUT_BASE_DIR", "../output")
OUTPUT_BASE_DIR = Path(output_base_dir_path) if Path(output_base_dir_path).is_absolute() else Path(__file__).resolve().parent / output_base_dir_path
QUEST3_DETAILS = OUTPUT_BASE_DIR / getenv("SCRIPT_03_QUEST3_DETAILS", "quest3_product_details.csv")
CONSOLIDATED_FILE = OUTPUT_BASE_DIR / getenv("SCRIPT_03_CONSOLIDATED_FILE", "consolidated_products.csv")
