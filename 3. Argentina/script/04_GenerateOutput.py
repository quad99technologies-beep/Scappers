...
# ---------- Paths / Options ----------
INPUT_FILE     = Path("./Output/alfabeta_products_all_dict_en.csv")
PCID_PATH      = Path("./Input/pcid_Mapping.csv")  # must contain the 5 columns listed below

# Auto-generate prefix with today's date in ddmmyyyy format
today_str      = datetime.now().strftime("%d%m%Y")
OUT_PREFIX     = f"alfabeta_Report_{today_str}"

EXCLUDE_PRICE  = False  # set True to drop "Public With VAT Price" from outputs
