@echo off
REM Canada Ontario Pipeline Runner - Enterprise Edition
...
set log_dir=..\..\output\CanadaOntario
set log_file=%log_dir%\CanadaOntario_run_%timestamp%.log
...
echo.
echo ================================================================================
echo Canada Ontario Pipeline - Completed at %date% %time%
echo ================================================================================
pause
