...
def example_fetch():
    ...
    from scripts.common import fetch, fetch_html, FetchMethod
...
def example_scraper_migration():
    ...
    AFTER:
        from scripts.common import fetch, register_url, insert_entity, insert_attributes
...
def example_worker_pipeline():
    ...
    """
    from scripts.common import update_run_step
...
def example_country_config():
    ...
    """
    from scripts.common.fetcher import (
        get_fetch_order,
        COUNTRY_FETCH_ORDER,
        TOR_COUNTRIES,
        API_COUNTRIES,
...
3. Start a worker: python scripts/common/worker.py
4. Start the GUI: streamlit run scripts/common/gui.py
