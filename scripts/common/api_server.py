...
Usage (standalone):
    ...
    python scripts/common/api_server.py                    # default 0.0.0.0:8000
    python scripts/common/api_server.py --port 9000        # custom port

Usage (embedded — started from GUI):
    from scripts.common.api_server import start_embedded, stop_embedded
