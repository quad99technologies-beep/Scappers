...
Usage:
    python scripts/common/backup_archive.py --strategy daily
    python scripts/common/backup_archive.py --strategy weekly
    python scripts/common/backup_archive.py --strategy monthly
"""
