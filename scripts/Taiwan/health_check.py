...
# -*- coding: utf-8 -*-
"""
Health check for Taiwan scraper.
...
def check_input_files() -> tuple:
    ...
    try:
        ...
        atc_file = input_dir / "ATC_L3_L4_Prefixes.csv"
        if atc_file.exists():
            return True, f"Input file found: {atc_file.name}"
        return False, f"Input file missing: {atc_file}"
    except Exception as e:
...
def main():
    ...
    print("=" * 60)
    print("Taiwan Scraper - Health Check")
    print("=" * 60)
    checks = [
