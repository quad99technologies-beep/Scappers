@echo off
REM Tender Chile Pipeline Runner - Enterprise Edition
...
set log_dir=..\..\output\Tender_Chile
set log_file=%log_dir%\Tender_Chile_run_%timestamp%.log
...
echo.
echo ================================================================================
echo Tender Chile Pipeline - Completed at %date% %time%
echo ================================================================================
pause
