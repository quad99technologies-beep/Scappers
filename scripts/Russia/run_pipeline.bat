@echo off
REM Russia Pipeline Runner - Enterprise Edition
...
set log_dir=..\..\output\Russia
set log_file=%log_dir%\Russia_run_%timestamp%.log

if not exist "%log_dir%" mkdir "%log_dir%"

echo ================================================================================
echo Russia Pipeline - Starting at %date% %time%
echo ================================================================================
echo Log: %log_file%
...
echo.
echo ================================================================================
echo Russia Pipeline - Completed at %date% %time%
echo ================================================================================
pause
