@echo off
REM Tender Brazil Pipeline Runner - Enterprise Edition
...
set log_dir=..\..\output\Tender_Brazil
set log_file=%log_dir%\Tender_Brazil_run_%timestamp%.log

if not exist "%log_dir%" mkdir "%log_dir%"

echo ================================================================================
echo Tender Brazil Pipeline - Starting at %date% %time%
echo ================================================================================
echo Log: %log_file%
...
echo.
echo ================================================================================
echo Tender Brazil Pipeline - Completed at %date% %time%
echo ================================================================================
pause
