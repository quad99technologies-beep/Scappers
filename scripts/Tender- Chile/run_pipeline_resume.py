...
def main():
    ...
    steps = [
        ...
        (1, "01_get_redirect_urls.py", "Get Redirect URLs", ["tender_redirect_urls.csv"]),
        (2, "02_extract_tender_details.py", "Extract Tender Details", ["tender_details.csv"]),
        (3, "03_extract_tender_awards.py", "Extract Tender Awards", ["mercadopublico_supplier_rows.csv", "mercadopublico_lot_summary.csv"]),
