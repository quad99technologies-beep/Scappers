...
Usage:
    python scripts/view_run_metrics.py                    # List all runs
    python scripts/view_run_metrics.py --scraper Malaysia # Filter by scraper
    python scripts/view_run_metrics.py --run-id <id>      # Show specific run
    python scripts/view_run_metrics.py --summary          # Show summary stats
    python scripts/view_run_metrics.py --last 10          # Show last 10 runs
"""
