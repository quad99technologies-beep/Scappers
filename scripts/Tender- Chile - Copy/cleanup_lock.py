...
try:
    from config_loader import getenv_int, getenv_float
    MAX_RETRIES_CLEANUP = getenv_int("MAX_RETRIES_CLEANUP", 5)
    CLEANUP_RETRY_DELAY_BASE = getenv_float("CLEANUP_RETRY_DELAY_BASE", 0.3)
except ImportError:
