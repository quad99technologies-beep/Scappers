...
def cli_examples():
    ...
    python core/url_worker.py --scraper India --run-id 20260215_120000 --batch-size 50
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python distributed_example.py start-india")
        print("  python distributed_example.py monitor <run_id>")
        print("  python distributed_example.py start-russia")
        print("  python distributed_example.py queue-ops")
        sys.exit(1)
    ...
    if command == "start-india":
        ...
        print(f"\nNow monitor with: python distributed_example.py monitor {run_id}")
    
    elif command == "monitor":
        if len(sys.argv) < 3:
            print("Usage: python distributed_example.py monitor <run_id>")
            sys.exit(1)
