@echo off
REM Italy Pipeline Runner - Enterprise Edition
...
set log_dir=..\..\output\Italy
set log_file=%log_dir%\Italy_run_%timestamp%.log

if not exist "%log_dir%" mkdir "%log_dir%"

echo ================================================================================
echo Italy Pipeline - Starting at %date% %time%
echo ================================================================================
echo Log: %log_file%
...
echo.
echo ================================================================================
echo Italy Pipeline - Completed at %date% %time%
echo ================================================================================
pause
